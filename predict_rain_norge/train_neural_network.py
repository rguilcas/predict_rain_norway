...
def main(config_path=None):
    ...
    wandb_logger = loggers.WandbLogger(project="WNorway_rainfall_attributions", 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_path", type=str, default="/home/rogui7909/code/predict_rain_norway/predict_rain_norge/ml_module_rain/configs/config-defaults.yaml", help="path to config file")
