...
class Encoder(nn.Module):
    def __init__(self, input_channels, num_layers,
        ...
        for layer in range(self.num_layers):
            ...
            if use_residuals: 
                module =  ResidualBlock(ConvolutionBlock, in_channels_layer, out_channels_layer,downsample_mode = downsample_modes[layer], ** kwargs_per_layer[layer])
            else:
                module =  ConvolutionBlock(in_channels_layer, out_channels_layer,downsample_modes[layer], ** kwargs_per_layer[layer])
